...
function fixname(name) {
    const ccName = (0, camelcase_1.default)(name);
...
function eslintPluginPostCSSModules(options = {}) {
    ...
    return (0, rollup_plugin_postcss_1.default)(Object.assign({ plugins: [...plugins], modules: Object.assign({ getJSON }, modulesOptions), autoModules: false, namedExports }, rest));
}
